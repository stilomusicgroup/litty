...
// No runtime imports needed — this file only exports types and getPackBySku.

// ─── Pack Configuration (open-amount only — PACK_CONFIG tiers removed) ─────────
//
// PACK_CONFIG tiers have been removed. This file uses open-amount (pay-what-you-want)
// checkout exclusively. getPackBySku recognises any pack_* SKU as the open-amount pack
// so the webhook dedup check continues to work.
...
const OPEN_AMOUNT_PACK: PackConfig = {
  id: 'studio',
  sku: 'pack_studio',
  name: 'Open Amount',
  nftCount: 0,
 ...
 */
export function getPackBySku(sku: string): PackConfig | undefined {
